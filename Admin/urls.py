...
urlpatterns = [
    ...
    path("assigned_applications_list/", assigned_applications_list, name="assigned_applications_list"),
    path("all_applications_list/", all_applications_list, name="all_applications_list"),
    ...
    path("documents/application/<uuid:pk>/refusals/download/", download_refusal_letters, name="application-refusal-letters-zip",),
