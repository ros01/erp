...
urlpatterns = [
    ...
    path("student/cas/start/", StartCASAPIView.as_view()),
    path("student/cas/<uuid:pk>/issue/", IssueCASAPIView.as_view()),
    ...
    path("applications/<uuid:id>/dashboard-detail/", CaseOfficerDashboardApplicationDetailAPIView.as_view(), name="applications-dashboard-detail"),
    ...
    path("applications/assigned/", AssignedApplicationsListAPIView.as_view(), name="assigned-application-list"),
    path("applications/all/", AllApplicationsListAPIView.as_view(), name="all-application-list"),
    path("case-officers/", AvailableCaseOfficersListAPIView.as_view(), name="case-officer-list"),
    path("applications/<uuid:pk>/validate_assignment/", ValidateApplicationAssignmentAPIView.as_view(), name="application-validate-assignment"),
    path("applications/<uuid:pk>/reassign_officer/", ReassignApplicationOfficerAPIView.as_view(), name="application-reassign-officer"),
    ...
    path("applications/notified_applications_list/", NotifiedApplicationsListAPIView.as_view(), name="notified-applications-list"),
    path("applications/<uuid:pk>/notify_client/", NotifyClientAPIView.as_view(), name="application-notify-client"),
    ...
    path("applications/<uuid:pk>/upload_refusal_letter/", UploadRefusalLetterAPIView.as_view(), name="upload-refusal-letter"),
    ...
    path("case-officer/dashboard-metrics/", CaseOfficerDashboardMetricsAPIView.as_view(), name="case-officer-dashboard-metrics"),
    path("admin/dashboard-metrics/", AdminDashboardMetricsAPIView.as_view(), name="admin-dashboard-metrics"),
